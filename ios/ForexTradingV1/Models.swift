...
struct Decision: Codable, Identifiable { var id:String{"\(symbol ?? "decision")-\(at ?? ts ?? 0)"}; let symbol:String?; let action:String?; let score:Double?; let regime:String?; let text:String?; let reason:String?; let at:Double?; let ts:Double? }
